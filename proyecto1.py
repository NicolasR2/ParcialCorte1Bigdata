...
def process_html(file_name):
    ...
    for listing in listings:
        ...
        # Agregar datos
        data.append([fecha_descarga, titulo, precio, ubicacion, habitaciones, banos, mts2])
    
    print(f"✅ Se procesaron {len(data)} propiedades")

    # Crear un DataFrame con los datos
    df = pd.DataFrame(data, columns=["FechaDescarga", "Titulo", "Precio", "Ubicacion", "Habitaciones", "Banos", "Mts2"])
    print("✅ DataFrame creado con éxito")

    # Guardar en S3 como CSV
